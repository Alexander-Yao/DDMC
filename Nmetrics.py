...
def acc(y_true, y_pred):
    ...
    # for i, j in ind:
    #     print(i, j)
    # print(sum(w[ind[0], ind[1]]))
    return sum(sum([w[ind[0], ind[1]]])) * 1.0 / y_pred.size
    # return 0.1
...
def test(y_true, y_pred):
    ...
    # print(acc(y_true, y_pred),'==',nmi(y_true, y_pred),vmeasure(y_true, y_pred),ari(y_true, y_pred),purity(y_true, y_pred))
